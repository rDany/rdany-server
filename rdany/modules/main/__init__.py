...
<form action="//rdany.us16.list-manage.com/subscribe/post?u=a343706c22f9f026c817c095c&amp;id=3a096c2bc8" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
	<label for="mce-EMAIL">Subscribe to rDany mailing list</label>
	<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required>
    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_a343706c22f9f026c817c095c_3a096c2bc8" tabindex="-1" value=""></div>
...
def mvp_api():
    ...
    for n in range(0, len(answers)):
        answers[n] = answers[n].replace("#subscribeform#", subscribeform)
